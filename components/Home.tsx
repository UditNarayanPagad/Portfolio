...
const Home = () => {
  return (
    <section id="home" className="text-white w-full bg-black-100 px-10">
      <FloatingNav navItems= {navItems}/>
      
      <Spotlight className="absolute top-52 h-screen" fill="pink" />
      <Spotlight className="absolute -top-16 right-10 " fill="blue" />

      <div className="h-[60vh] sm:h-[60vh] md:h-[70vh] lg:h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.3] bg-grid-black/[0.3] relative flex items-center justify-center">
        ...
        <h2 className="text-blue-200 font-semibold my-3 text-xs sm:text-lg">Hey, I&apos;m Udit, A{<FlipWords words={["Frontend","React","Next.js","Backend","FullStack"]}/>}developer</h2>
